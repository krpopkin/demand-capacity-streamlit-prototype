...
OUTPUT_FILES = {
    'assignments': 'RAG/data/raw/assignments.json',
    'products': 'RAG/data/raw/products.json',
    'roles': 'RAG/data/raw/roles.json',
    'skills_matrix': 'RAG/data/raw/skills_matrix.json',
    'teammembers': 'RAG/data/raw/teammembers.json'
}
